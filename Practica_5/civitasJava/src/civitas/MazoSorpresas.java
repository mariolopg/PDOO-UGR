...
public class MazoSorpresas {
  ...
  */
  ...
  public String toString() {
      String mensaje = "MazoSorpresas{ sorpresas = [";
      for (int i=0; i<sorpresas.size(); i++)
          mensaje += sorpresas.get(i).getTexto() + ", " ;
      mensaje += ']' + ", barajada= "+ barajada + ", usadas=" + usadas + ", debug=" + debug
        + ", cartasEspeciales=" + cartasEspeciales + ", ultimaSorpresa=" + ultimaSorpresa + '}'; 
