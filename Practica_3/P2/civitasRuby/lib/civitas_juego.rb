...
#public # para la prueba en civitas juego
    ...
    def inicializar_tablero(mazo)
      ...
      area_c1 = Area.new(Tipo_area::COMERCIAL)
      area_c1.aniadir_titulo_propiedad(Titulo_propiedad.new("Manila", 50, 0.5, 250, 500, 250))
      area_c1.aniadir_titulo_propiedad(Titulo_propiedad.new("Denver", 170, 1.2, 850, 1700, 875))
      
      area_c2 = Area.new(Tipo_area::COMERCIAL)
      area_c2.aniadir_titulo_propiedad(Titulo_propiedad.new("Tokio", 200, 0.9, 1000, 20000, 1000))
      area_c2.aniadir_titulo_propiedad(Titulo_propiedad.new("Rio", 180, 1.1, 900, 1800, 875))
      
      area_res = Area.new(Tipo_area::RESIDENCIAL)
      area_res.aniadir_titulo_propiedad(Titulo_propiedad.new("Tokio", 200, 0.9, 1000, 20000, 1000))
      area_res.aniadir_titulo_propiedad(Titulo_propiedad.new("Palermo", 80, 0.85, 400, 960, 500))
    ...
    def muestra_areas
      puts "Numero de areas #{@areas.size}"
