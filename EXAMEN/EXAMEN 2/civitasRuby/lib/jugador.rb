...
module Civitas
  class Jugador
    ...
    def puedo_edificar_casa(propiedad)
      ...
      if puedo_gastar(propiedad.precio_edificar) && propiedad.num_casas < self.CASAS_MAX
    ...
    def puedo_edificar_hotel(propiedad)
      ...
      if puedo_gastar(propiedad.precio_edificar) && propiedad.num_hoteles < self.HOTELES_MAX && propiedad.num_casas >= @@CASAS_POR_HOTEL
      ...
      if(!@encarcelado && existe_la_propiedad(ip))
        ...
        if(puedo_gastar)
          ...
          if propiedad_sostenible != nil
            ...
            Diario.instance.ocurre_evento("El jugador #{@nombre} tiena ahora la propiedad sostenible #{propiedad_sostenible}")
          end
        end
      end
...
#----------------------------------------------
    protected :debe_ser_encarcelado, :saldo, :CASAS_MAX, :HOTELES_MAX, :puedo_gastar
    private :existe_la_propiedad, :perder_salvoconducto, :puede_salir_carcel_pagando, :puedo_edificar_casa, :puedo_edificar_hotel
  end
end
