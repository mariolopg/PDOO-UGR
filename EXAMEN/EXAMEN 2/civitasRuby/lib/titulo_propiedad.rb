...
module Civitas
  ...
  class Titulo_propiedad
    ...
    attr_reader :hipotecado, :nombre, :num_casas,
                ...
                :propietario, :factor_revalorizacion, :hipoteca_base
    ...
    def hacerme_sostenible(jugador)
      ...
      if es_el_propietario
        ...
        propiedad_sostenible = Titulo_propiedad_sostenible.new(@nombre, @alquler_base, @factor_revalorizacion, @precio_base, @precio_compra, @precio_edificar, 0.05)
      end
      return propiedad_sostenible
    end
    
    def get_importe_hacerme_sostenible
      return get_precio_venta * calcular_porcentaje_inversion_por_sostenibilidad
    end
    
    def calcular_porcentaje_inversion_por_sostenibilidad
      porcentaje = 0
      if @num_casas > 0 || @num_hoteles > 0
        porcentaje = 0.02
      else
        porcentaje = 0.05
      end
