...
public class CivitasJuego {
  ...
  */
  public CivitasJuego(ArrayList<String> nombres) {
    ...
    cajonRegalos = new ArrayList<Regalo>();
  ...
  private void inicializarMazoSorpresas(Tablero tablero) {
      ...
      mazo.alMazo(new SorpresaRegalo("Regalo", cajonRegalos));
      mazo.alMazo(new SorpresaRegalo("Regalo", cajonRegalos));
      
    Random random = new Random();     //Creamos una variable random para randomizar los valores de las cartas
    int valor;
    
    valor = random.nextInt(1) + 1000;
    mazo.alMazo(new SorpresaEspeculador(valor, "Te conviertes en jugador especulador. Tu fianza para librarte de la carcel es " + valor));
  ...
  public boolean vender(int ip) {
    ...
    public int getIndiceJugadorActual() { //Para GUI
        return indiceJugadorActual;
    }
    
    private void inicializaCajonRegalos(){
        Regalo r1 = new Regalo("OsoPeluche", TipoRegalo.JUGUETE);
        Regalo r2 = new Regalo("LeonPeluche", TipoRegalo.JUGUETE);
        Regalo r3 = new Regalo("Silla", TipoRegalo.MUEBLE);
        Regalo r4 = new Regalo("DiscoVinilo", TipoRegalo.MUSICA);
