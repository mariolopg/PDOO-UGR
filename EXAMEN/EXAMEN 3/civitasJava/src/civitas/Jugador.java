...
public class Jugador implements Comparable<Jugador> {
  ...
  private SorpresaSalirCarcel salvoconducto; // tipo salir carcel
   ...
   */
  public String getNombre() { //Publico para GUI
    return nombre;
  }
   ...
   */
  public int getNumCasillaActual() { //Public para GUI
   ...
   */
  public float getSaldo() { //Public para GUI
    return saldo;
  }
  ...
  */
  ...
  boolean moverACasilla(int numCasilla) {
    ...
    if (isEncarcelado())
      ...
      puedeComprar = false;
      Diario.getInstance().ocurreEvento("El jugador " + getNombre() + " se ha movido a la casilla " + getNumCasillaActual());
    }
    return esMovido;
  }
   ...
   */
  //Cambiamos visibilidad para poder llamarlo en JugadorEspeculador
  ...
  public String toString() {
    return "Jugador{" + "encarcelado=" + encarcelado + ", nombre=" + nombre + ", numCasillaActual=" + numCasillaActual
        + ", puedeComprar=" + puedeComprar + ", saldo=" + saldo + ", regalos=" + regalos + '}';
  }
  ...
  public void sacarRegalo(ArrayList<Regalo> cajonRegalos){
      regalos.add(cajonRegalos.get(0));
      cajonRegalos.remove(0);
  }
  
  public ArrayList getRegalos(){
      return regalos;
  }
}
