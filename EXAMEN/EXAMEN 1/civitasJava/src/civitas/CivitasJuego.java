...
public class CivitasJuego {
  ...
  */
  ...
  private void inicializarTablero(MazoSorpresas mazo) {
    ...
    tablero.añadeCasilla(new Casilla (new TituloPropiedad("Nairobi", 60, (float)0.95, 150, 300, 125)));
    
    tablero.añadeCasilla(new Casilla("Estacion_Cercanias", TipoEstacion.cercanias));
    ...
    tablero.añadeCasilla(new Casilla("Estacion_LDistancia", TipoEstacion.largaDistancia));
    ...
    tablero.añadeCasilla(new Casilla("Estacion_Multiple", TipoEstacion.multiple));
    ...
    tablero.añadeCasilla(new Casilla (new TituloPropiedad("Tokio", 200, (float)0.9, 1000, 2000, 1000)));
