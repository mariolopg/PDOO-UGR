...
*/
    ...
    */
    ...
    /*
      Consultor getCarcel
        Devuelve:
          El numero de casilla en la que se encuenta la Carcel
    */
    ...
    */
    ...
    public String toString() {
        return "Tablero{" + "numCasillaCarcel=" + numCasillaCarcel + ", casillas=" + casillas + ", porSalida=" + porSalida + ", tieneJuez=" + tieneJuez + '}';
    }
