 ...
 */
   MazoSorpresas(Boolean d){
    ...
    init();
    if (debug)
      Diario.getInstance().ocurreEvento("Mazo Sorpresas en modo Debug");
    else
      Diario.getInstance().ocurreEvento("Mazo Sorpresas en modo no Debug");
  }
...
void habilitarCartaEspecial(Sorpresa sorpresa){
  ...
  if( cartasEspeciales.contains(sorpresa) ){
    ...
    public String toString() {
        return "MazoSorpresas{" + "sorpresas=" + sorpresas + ", barajada=" + barajada + ", usadas=" + usadas + ", debug=" + debug + ", cartasEspeciales=" + cartasEspeciales + ", ultimaSorpresa=" + ultimaSorpresa + '}';
    }
