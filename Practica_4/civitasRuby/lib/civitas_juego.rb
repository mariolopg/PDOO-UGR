...
#public # para la prueba en civitas juego
    ...
    def inicializar_tablero(mazo)
      ...
      @tablero.aniade_casilla(Casilla_calle.new (Titulo_propiedad.new("Nairobi", 60, 0.95, 150, 300, 125)))
      
      #Sorpresa
      #@tablero.aniade_casilla(Casilla_sorpresa.new(mazo, "Sorpresa"))

      @tablero.aniade_casilla(Casilla_calle.new(Titulo_propiedad.new("Manila", 50, 0.5, 250, 500, 250)))
